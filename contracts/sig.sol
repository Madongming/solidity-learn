...
contract VerifySig {
    ...
    function getMessageHash(string calldata _message) private pure returns(bytes32) {
    ...
    function split(bytes memory _sig) private pure returns(bytes32 r, bytes32 s, uint8 v) {
